					...
					if (gen_state != GEN_OFF)	//Generator is not off, so must be starting/started
					{
						...
						//	double *bid=gl_get_double_by_name(parent2,"E_Max");
							...
							if(first_time==2)
							{
								...
								{
								printf("edw");
								bidID_val=auction_object->submit(obj,(*bid_power_active)/4000,contr_price,-1,BS_ON);
								}
							}
					...
					{	
						...
						//	printf("plaus\\n\n\n\n\n");
							...
							if(first_time==2)
							{
								...
								{
									printf("edw");
								bidID_val=auction_object->submit(obj,((*bid_power_active)/4000),contr_price,-1,BS_OFF);
