...
extraction_file = 'C:\Users\Antonia\Documents\PhD\My Papers\Agricultural -Conference-Journal\Implementation\testing_folder\R4_SECOND_SCENARIO\IEEE_13_mod.glm';
swing_node = '650';
...
%% Markets? - FINISHED
use_market = 1; % 0 = NONE, 1 = BIDDING, 2 = PASSIVE (NON-BIDDING)
...
market_info = {'MARKET';'Market_pool';900;'current_price_mean_24h';'current_price_stdev_24h';0.5;'ExamplePrices2.player'};
...
if (use_market == 1)
  ...
  %  fprintf(write_file,'     parent tn_B__645;\n');
    fprintf(write_file,'    period 900;\n');
    fprintf(write_file,'    init_price 30;\n');
    fprintf(write_file,'    init_stdev 5;\n');
%     fprintf(write_file,'    town_factory seller1_volos;\n');
%     fprintf(write_file,'    second_bidder seller2_volos;\n');
 %     fprintf(write_file,'   type 0;\n');
       fprintf(write_file,'    warmup 0;\n');
       
        fprintf(write_file,'    object multi_recorder {\n');
    fprintf(write_file,' 	property current_market.clearing_price,current_market.clearing_quantity;\n');
	fprintf(write_file,' 	file "market_1.csv";\n');
	fprintf(write_file,' 	interval 900;\n');
	fprintf(write_file,' 	limit 168;\n');
    fprintf(write_file,' 	};\n');
    
    fprintf(write_file,'}\n\n');
    end 
%     
%     fprintf(write_file,'    object stub_bidder{\n');
%     fprintf(write_file,'        name seller1_volos;\n');
%     fprintf(write_file,'        role SELLER;\n');
%     fprintf(write_file,'        bid_period 900;\n');
%     fprintf(write_file,'        market %s;\n',market_info{2});
%     fprintf(write_file,'        price 100;\n');
%     fprintf(write_file,'        quantity 200;\n');
%     fprintf(write_file,'        count 10000;\n');
%     fprintf(write_file,'     };\n');
%     
% %        fprintf(write_file,'    object stub_bidder{\n');
% %     fprintf(write_file,'        name seller2_volos;\n');
% %     fprintf(write_file,'        role SELLER;\n');
% %     fprintf(write_file,'        bid_period 900;\n');
% %     fprintf(write_file,'        market Market_second;\n');
% %     fprintf(write_file,'        price 0;\n');
% %     fprintf(write_file,'        quantity 0;\n');
% %     fprintf(write_file,'        count 10000;\n');
% %     fprintf(write_file,'     };\n');
%     
% 
...
% %  fprintf(write_file,'object auction {\n');
% %     fprintf(write_file,'    name Market_second;\n');
% %     fprintf(write_file,'    special_mode NONE;\n');
% %     fprintf(write_file,'    unit kW;\n');
% %     fprintf(write_file,'    period %.0f;\n',market_info{3});
% %     fprintf(write_file,'    warmup 0;\n');
% %     fprintf(write_file,'    type 1;\n');
% %     fprintf(write_file,'    fixed_price 50;\n');
% %     fprintf(write_file,'    object multi_recorder {\n');
% %     fprintf(write_file,' 	property current_market.clearing_price,current_market.clearing_quantity;\n');
% % 	fprintf(write_file,' 	file "market_second.csv";\n');
% % 	fprintf(write_file,' 	interval 900;\n');
% % 	fprintf(write_file,' 	limit 168;\n');
% %     fprintf(write_file,' 	};\n');
% %     
...
fprintf(write_file,'     name trans_config_to_feeder_1;\n');
...
fprintf(write_file,'     name network_node_1;\n');
...
fprintf(write_file,'     name substation_transformer_12;\n');
fprintf(write_file,'     object recorder {\n');
...
fprintf(write_file,'     from network_node_1;\n');
fprintf(write_file,'     to %s;\n',swing_node);
fprintf(write_file,'     phases ABCN;\n');
fprintf(write_file,'     configuration trans_config_to_feeder_1;\n');  
fprintf(write_file,'}\n\n');
        ...
        for kk=1:no_houses
            ...
            if (heat_type > perc_gas && use_wh == 1)
                ...
                fprintf(write_file,'          demand water%d*1;\n',water_sch);
                 ...
                 if(use_market == 1)	
                              fprintf(write_file,'  object controller {\n');
                                           fprintf(write_file,'    schedule_skew -910;\n');
                                            fprintf(write_file,'   market %s%s;\n',market_info{2},town);
                                            
                                           fprintf(write_file,'      bid_mode ON;\n');
						                   fprintf(write_file,'      control_mode RAMP;\n');
						                   fprintf(write_file,'      resolve_mode DEADBAND;\n');
						                   fprintf(write_file,'      period 900;\n');
						                    fprintf(write_file,'           average_target current_price_mean_24h;');
                                           fprintf(write_file,'           standard_deviation_target current_price_stdev_24h;');         
						                   fprintf(write_file,'  target inlet_water_temperature;\n');
						                   fprintf(write_file,'  setpoint tank_setpoint;\n');
						                   fprintf(write_file,'  demand actual_load;\n');
                                            fprintf(write_file,'           deadband thermostat_deadband;\n');
						                   fprintf(write_file,'  total actual_load;\n');
						                   fprintf(write_file,' load actual_load;\n');
						                   fprintf(write_file,'  };\n');
...
if (no_loads ~= 0)
    ...
    fprintf(write_file,'      name trip_line_config_1;\n');
        ...
        for jjj = 1:3
            ...
            if load_houses{jjj}{iii} ~= 0
                ...
                for kk=1:no_houses/2
                    ...
                    fprintf(write_file,'       configuration trip_line_config_1;\n');
                    fprintf(write_file,'       groupid %s;\n','Triplex_Line');
                    fprintf(write_file,'}\n\n');
